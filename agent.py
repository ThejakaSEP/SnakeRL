...
class Agent:
    ...
    def __init__(self):
        ...
        self.memory = deque(maxlen=MAX_MEMORY) # if exceed the memory popleft()
    ...
    def get_state(self,game):
        ...
        point_u = Point(head.x,head-20)
        point_d = Point(head.x,head+20)
    ...
    def train_long_memory(self):
        ...
        # for state,action,reward,next_state,done in mini_sample: (Can do this instead of ZIP function above
